        ...
        <section className="mb-16">
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg overflow-hidden">
                        <div className="p-4 border-b border-white/10 bg-white/5">
                            <code className="text-teal-glow font-mono text-sm">RUNWARE_API_KEY</code>
                            <span className="ml-3 px-2 py-0.5 bg-blue-500/20 text-blue-300 text-xs rounded">Optional</span>
                        </div>
                        <div className="p-4">
                            <p className="text-gray-300 mb-2 text-sm">For AI image generation (signal graphics).</p>
                            <p className="text-gray-400 text-xs">Get from: <a href="https://runware.ai" target="_blank" rel="noopener noreferrer" className="text-teal-glow hover:underline">runware.ai</a></p>
                        </div>
                    </div>
                </div>
