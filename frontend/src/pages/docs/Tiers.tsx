            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                    ...
                    <ul className="space-y-2 text-gray-300">
                        <li className="flex items-start gap-2">
                            <span className="text-teal-glow mt-1">✓</span>
                            <span><strong className="text-white">Public signals</strong> - Posted to X (Twitter) 30 minutes after initial broadcast</span>
                        </li>
                        <li className="flex items-start gap-2">
                            <span className="text-teal-glow mt-1">✓</span>
                ...
                <div className="relative pl-8 space-y-6">
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                            ...
                            <p className="text-gray-300 text-sm">Signal posted to X (Twitter) +30 minutes later</p>
                        </div>
                    </div>
                </div>
            </div>
