    ...
    <DocsLayout>
      <div className="prose prose-invert prose-lg max-w-none">
        ...
        <section className="mb-16" id="scanner">
            ...
            <div className="mb-8">
                <img src="/signals.png" alt="Live Signals" className="w-full rounded-xl border border-white/10 shadow-2xl" />
                <p className="text-center text-gray-400 text-sm mt-2">Live trading signals generated by Scanner and Analyzer agents</p>
            </div>
...
// Example LONG Signal
{
  ...
  "leverage": 10
        ...
        <section className="mb-16" id="intel">
            ...
            <div className="mb-8">
                <img src="/intel.png" alt="Intel Feed" className="w-full rounded-xl border border-white/10 shadow-2xl" />
                <p className="text-center text-gray-400 text-sm mt-2">Market intelligence and narrative analysis</p>
            </div>
        ...
        <section className="mb-16" id="predictor">
            ...
            <div className="mb-8">
                <img src="/predictions.png" alt="Predictions" className="w-full rounded-xl border border-white/10 shadow-2xl" />
                <p className="text-center text-gray-400 text-sm mt-2">Polymarket opportunities with edge analysis (Diamond tier exclusive)</p>
            </div>
